...
connection_live = http.client.HTTPConnection('www.google.com', 80)
connection_live.request("OPTIONS", "*")
response_live = connection_live.getresponse()
...
def create_label(text, xpo, ypo, height, width, colour):
    font=pygame.font.Font(None, 42)
    label=font.render(str(text), 1, (colour))
    screen.blit(label,(xpo,ypo))
...
create_label("FPI Status", 150, 10, 30, 50, green_colour)
create_label(live_test(), 265, 105, 55, 210, green_colour)
create_label("PROD", 25, 105, 55, 210, orange_font)
# create_button("Crack WPA", 265, 105, 55, 210, orange_font)
create_label("PRE-PROD", 25, 180, 55, 210, orange_font)
# create_button("Jam Wi-fi", 265, 180, 55, 210, orange_font)
create_label("Integration", 25, 255, 55, 210, orange_font)
