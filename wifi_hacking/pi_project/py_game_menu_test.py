...
#set size of the screen, making them variables
size_width = 480
size_height = 320
screen = pygame.display.set_mode((size_width,size_height))

# Load in images
no_con =pygame.image.load('no_connection.jpg')
yes_con =pygame.image.load('yes_connection.jpg')

# define connected image
def connected_image(x,y):
        screen.blit(yes_con,(x,y))
...
make_button("More     >>>", 260, 255, 55, 210, blue)
